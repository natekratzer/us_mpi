...
intensity_tbl_st <- svyby(~income_poverty+fam_emp+health+disability+education+overcrowd+hcost_dep+
                           computer_internet+lang_dep+mpi_poor, ~STATEFIP, design = intensity_df, svymean)


intensity_mpi <- intensity_tbl_st %>%
  mutate(intensity = (income_poverty*(1/9) + 
  fam_emp*(1/9) + 
  health*(1/6) + 
  education*(1/6) +
  overcrowd*(1/12) +
  computer_internet*(1/12) + 
  disability*(1/12) +
  lang_dep * (1/12) +
  hcost_dep * (1/9)))
