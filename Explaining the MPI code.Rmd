...
per_contrib_fem <- (gender_df$`Female Mean`[2:10]/adjusted_hc)*weights
per_contrib_male <- (gender_df$`Male Mean`[2:10]/adjusted_hc)*weights
per_contrib_gender <- cbind.data.frame(per_contrib_fem, per_contrib_male)
names(per_contrib_gender) <- c("Female", "Male")
row.names(per_contrib_gender) <- c("MPI Poor", "Income", "Employment", "Health Insurance", "Disability", "Education", "Overcrowding", "Housing Cost", "Internet", "Linguistic Isolation")
