...
# survey_df <- svydesign(ids = ~1, weights = ~PERWT, data = mpi_data_15)
# 
# svymean(~overcrowd+income_poverty+fam_emp, design = survey_df)
# svyby(~overcrowd+income_poverty+fam_emp, ~I(SEX == 1),design=survey_df, svymean)
# 
# 
# svyttest(overcrowd~SEX, survey_df)
# svyby(~overcrowd,~I(SEX == 1),design=survey_df, svymean)
# summary(svyglm(overcrowd~I(SEX == 1)+0,design = survey_df))
# 
# 
# 
